...
const TierCard = ({ itemData }: Props) => {
  ...
  return (
    <div className={`flex flex-col items-center py-2 w-24 text-sm font-semibold rounded-sm ${categoryColor(itemData.category)} ${(categoryHover !== itemData.category && !!categoryHover) && 'opacity-30'}`}>
