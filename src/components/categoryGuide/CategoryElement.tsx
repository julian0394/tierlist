...
const CategoryElement = ({ name, categoryKey }: Props) => {
  ...
  return (
    <div onMouseEnter={() => setCategoryHover(categoryKey)} onMouseLeave={() => setCategoryHover(null)} className="flex items-center gap-2 p-2 hover:bg-slate-400/40 cursor-pointer rounded-md transition-colors duration-150 select-none">
