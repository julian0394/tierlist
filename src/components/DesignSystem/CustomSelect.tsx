...
const CustomSelect = ({
  ...
  return (
    ...
    >
      ...
      <Button ref={field.ref} className={twMerge(
          ...
          // field.value === '' && 'text-slate-400 font-light',
          ...
          // error && 'border-rose-500 ring-1 ring-rose-300 focus:border-red-700 focus:ring-red-500 hover:border-red-600'
        )}
      >
        <SelectValue>
      ...
      <Popover className="w-[--trigger-width]" placement="bottom">
        <ListBox className="p-1 m-0 bg-white rounded-md border border-slate-300 text-slate-600 focus:outline-none">
          { allowClear && 
            <ListBoxItem
