...
export const tierlistData: TierlistItem[] = [
  ...
  { name: 'StyleX', affinity: 'C', affection: 'B', logo: LOGOS.stylexLogo, category: CATEGORIES.STYLES.key },
  ...
  { name: 'React Native', affinity: 'F', affection: 'F', logo: LOGOS.reactNativeLogo, category: CATEGORIES.FRAMEWORK.key },
  ...
  { name: 'Svelte', affinity: 'F', affection: 'F', logo: LOGOS.svelteLogo, category: CATEGORIES.FRAMEWORK.key },
